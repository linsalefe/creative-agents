...
export default function ChatPage() {
  ...
  async function loadHistory() {
    try {
      ...
      // History endpoint may not exist yet; start with empty
      setMessages([]);
    } finally {
  ...
  return (
    <AppShell>
      <div className="flex flex-col h-[calc(100vh-theme(spacing.16))] lg:h-[calc(100vh-theme(spacing.12))]">
        {/* Messages area */}
        <div
          ...
          {!loadingHistory && messages.length === 0 && !sending && (
            <div className="flex flex-col items-center justify-center h-full text-center px-4">
              ...
              <p className="text-lg font-medium text-foreground mb-2">
                Ola! Sou o assistente criativo da Creative Machine.
              </p>
              ...
              <div className="flex flex-wrap gap-2 justify-center">
                {SUGGESTION_CHIPS.map((chip) => (
                  <button
                    ...
                    className="px-4 py-2 rounded-full border border-border bg-card hover:bg-secondary text-sm text-foreground transition-colors duration-200"
                  >
                  ...
                  <div
                    className={`max-w-[70%] px-4 py-3 ${
                      msg.role === "user"
                        ...
                        : "bg-card rounded-2xl rounded-tl-sm border border-border"
                    }`}
                  >
                    {/* Image thumbnail */}
                    {msg.imagem_url && (
                      ...
                      >
                        <img
                          src={msg.imagem_url}
                          alt="Imagem"
                          className="rounded-lg max-w-full max-h-48 object-cover hover:opacity-90 transition-opacity cursor-pointer"
                        />
                      </a>
                    )}
        ...
        <div className="border-t border-border bg-card/50 backdrop-blur p-4">
          <div className="max-w-2xl mx-auto">
            {/* File preview */}
            {filePreview && (
              <div className="flex items-center gap-3 mb-3 p-2 bg-secondary rounded-lg">
                <img
                  src={filePreview}
                  alt="Preview"
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex-shrink-0 p-2.5 rounded-xl text-muted-foreground hover:text-foreground hover:bg-secondary transition-colors"
                title="Enviar imagem"
              >
              ...
              <input
                ...
                disabled={sending}
                className="flex-1 h-11 px-4 rounded-xl bg-secondary border-none text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring disabled:opacity-50"
              />
